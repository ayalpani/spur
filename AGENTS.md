...
- Present Home, including tour history, as a full-screen destination entering
  ...
  Animate the tour itself as a full-width panel entering from the right above
  Home, and reverse that motion on Back; never reveal it with a hard layer swap.
